<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bj.aspx.cs" Inherits="Chart.ueditor.bj" %>
	    ...
	    <div class="form-group">
	        <div class="row">
	            ...
	            <div class="col-md-9">    
	    			...
	    			<input type="text" id="remark" class="form-control" style="width:100%"   name="title" placeholder="输入文章标题">
	    		</div>
             ...
             <div class="row">
	            ...
	            <div class="col-md-9">    
	    			...
	    			<input type="text" id="jieduan" class="form-control" style="width:100%"  name="title" placeholder="请输入装修阶段">
	    		</div>
	            <div class="col-md-2"></div>
	        </div>
	        <div class="row">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#cmt").click(function () {
                ...
                $.post("AddNewMsg.aspx", { content: content, phone: '<%=Request["phone"] %>', stage: stage,remark:remark }, function (data) {
                
                    location.href = 'MessageList.aspx?phone=<%=Request["phone"] %>';
                })
